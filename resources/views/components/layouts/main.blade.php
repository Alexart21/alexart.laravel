...
<div id="container">
    ...
    <nav id="mobMenu" class="mob-menu-list">
        ...
        <ul>
            <li class="mob-link"><a class="portf-call" title="сайт визитка" href="">сайт
                    визитка</a></li>
                    ...
                    <a href="/">
                        <div id="logo" title="Алекс-арт21 создание и продвижение сайтов">
                            <img class="svg" width="240" height="138"
                                 ...
                                 src="{{ asset('img/main_img/logo.png')  }}">
                        </div>
                    </a>
                    <div id="right">
                        <div class="right_outer">
                            <ul>
                                ...
                                <li class="tel">
                                    ...
                                    <a href="tel:+79876680484" title="позвонить"
                                       itemprop="telephone">+7(987) 668-04-84</a>
                                </li>
                ...
                <div id="msg-content">
                    ...
                    <div class="msg-text">
                        ...
                        <i style="display:block;text-align: right"><span
                                class="fa fa-check"></span>13:50&nbsp;&nbsp;</i>
                    </div>
                    <hr>
